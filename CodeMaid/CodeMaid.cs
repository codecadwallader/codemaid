namespace SteveCadwallader.CodeMaid
{
    ...
    internal sealed partial class PackageGuids
    {
        ...
        public static Guid GuidVisualStudioCSSWindowContextMenu = new(GuidVisualStudioCSSWindowContextMenuString);
        public static Guid GuidVisualStudioCSSDocumentContextMenu = new(GuidVisualStudioCSSDocumentContextMenuString);
        public static Guid GuidVisualStudioHTMLWindowContextMenu = new(GuidVisualStudioHTMLWindowContextMenuString);
        public static Guid GuidVisualStudioHTMLDocumentContextMenu = new(GuidVisualStudioHTMLDocumentContextMenuString);
        public static Guid GuidVisualStudioJSONDocumentContextMenu = new(GuidVisualStudioJSONDocumentContextMenuString);
        public static Guid GuidVisualStudioXAMLWindowContextMenu = new(GuidVisualStudioXAMLWindowContextMenuString);
        public static Guid GuidCodeMaidPackage = new(GuidCodeMaidPackageString);
        public static Guid GuidCodeMaidToolWindowBuildProgress = new(GuidCodeMaidToolWindowBuildProgressString);
        public static Guid GuidCodeMaidToolWindowSpade = new(GuidCodeMaidToolWindowSpadeString);
        public static Guid GuidCodeMaidOutputPane = new(GuidCodeMaidOutputPaneString);
        public static Guid GuidCodeMaidMenuSet = new(GuidCodeMaidMenuSetString);
        public static Guid GuidCodeMaidImageMoniker = new(GuidCodeMaidImageMonikerString);
        public static Guid GuidImageCleanup = new(GuidImageCleanupString);
        public static Guid GuidImageCleanupAll = new(GuidImageCleanupAllString);
        public static Guid GuidImageCloseLocked = new(GuidImageCloseLockedString);
        public static Guid GuidImageCollapse = new(GuidImageCollapseString);
        public static Guid GuidImageCommentFormat = new(GuidImageCommentFormatString);
        public static Guid GuidImageFind = new(GuidImageFindString);
        public static Guid GuidImageInfo = new(GuidImageInfoString);
        public static Guid GuidImageJoin = new(GuidImageJoinString);
        public static Guid GuidImageLock = new(GuidImageLockString);
        public static Guid GuidImageOptions = new(GuidImageOptionsString);
        public static Guid GuidImageProgress = new(GuidImageProgressString);
        public static Guid GuidImageRefresh = new(GuidImageRefreshString);
        public static Guid GuidImageRemoveRegion = new(GuidImageRemoveRegionString);
        public static Guid GuidImageReorganize = new(GuidImageReorganizeString);
        public static Guid GuidImageSortAlpha = new(GuidImageSortAlphaString);
        public static Guid GuidImageSortNumeric = new(GuidImageSortNumericString);
        public static Guid GuidImageSortType = new(GuidImageSortTypeString);
        public static Guid GuidImageSpade = new(GuidImageSpadeString);
        public static Guid GuidImageSwitch = new(GuidImageSwitchString);
        public static Guid GuidImageUnlock = new(GuidImageUnlockString);
    }
    /// <summary>
