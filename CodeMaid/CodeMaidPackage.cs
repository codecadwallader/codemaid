...
namespace SteveCadwallader.CodeMaid
{
    ...
    [InstalledProductRegistration("#110", "#112", "v0.9.0.2 BETA", IconResourceID = 400, LanguageIndependentName = "CodeMaid")] // VS Help/About details (Name, Description, Version, Icon).
