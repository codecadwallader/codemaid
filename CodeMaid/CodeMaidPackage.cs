...
namespace SteveCadwallader.CodeMaid
{
    ...
    [InstalledProductRegistration("#110", "#112", "v0.7.9.1 beta", IconResourceID = 400, LanguageIndependentName = "CodeMaid")] // VS Help/About details (Name, Description, Version, Icon).
