...
namespace SteveCadwallader.CodeMaid
{
    ...
    [InstalledProductRegistration("#110", "#112", "v0.8.8 ALPHA", IconResourceID = 400, LanguageIndependentName = "CodeMaid")] // VS Help/About details (Name, Description, Version, Icon).
