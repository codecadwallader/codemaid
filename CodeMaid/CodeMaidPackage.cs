...
namespace SteveCadwallader.CodeMaid
{
	...
	public sealed class CodeMaidPackage : Package, IVsInstalledProduct
	{
		...
		/// </summary>
		private BuildProgressEventListener BuildProgressEventListener
		{
			get; set;
		}
		...
		/// </summary>
		private RunningDocumentTableEventListener RunningDocumentTableEventListener
		{
			get; set;
		}
		...
		/// </summary>
		private TextEditorEventListener TextEditorEventListener
		{
			get; set;
		}
