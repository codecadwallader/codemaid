...
namespace SteveCadwallader.CodeMaid.UI.Converters
{
    ...
    {
        /// <summary>
        /// An instance of <see cref="NullToBooleanConverter"/> that returns true if the specified value is null.
        /// </summary>
        public static NullToBooleanConverter IsNull = new NullToBooleanConverter { ReturnTrueIfNull = true };

        /// <summary>
        /// An instance of <see cref="NullToBooleanConverter"/> that returns true if the specified value is not null.
        /// </summary>
