...
namespace SteveCadwallader.CodeMaid {
    ...
    internal class VSPackage {
        ...
        /// <summary>
        ///   Looks up a localized string similar to CodeMaid is an open source Visual Studio extension to cleanup and simplify our C#, C++, F#, VB, PHP, PowerShell, JSON, XAML, XML, ASP, HTML, CSS, LESS, SCSS, JavaScript and TypeScript coding.
        ///
