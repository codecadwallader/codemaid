...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\FileTypes\Data\SCSS.scss", "Data")]
    public class SCSSTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _projectItem = TestEnvironment.LoadFileIntoProject(@"Data\SCSS.scss");
        }
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesSCSS_EnablesForDocument()
        {
            Settings.Default.Cleaning_IncludeSCSS = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesSCSS_EnablesForProjectItem()
        {
            Settings.Default.Cleaning_IncludeSCSS = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesSCSS_DisablesForDocumentWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeSCSS = false;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesSCSS_DisablesForProjectItemWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeSCSS = false;
