...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\FileTypes\Data\VisualBasic.vb", "Data")]
    public class VisualBasicTests
    {
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesVisualBasic_EnablesForDocument()
        {
            Settings.Default.Cleaning_IncludeVB = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesVisualBasic_EnablesForProjectItem()
        {
            Settings.Default.Cleaning_IncludeVB = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesVisualBasic_DisablesForDocumentWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeVB = false;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesVisualBasic_DisablesForProjectItemWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeVB = false;
