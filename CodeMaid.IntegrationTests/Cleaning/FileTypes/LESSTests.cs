...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\FileTypes\Data\LESS.less", "Data")]
    public class LESSTests
    {
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesLESS_EnablesForDocument()
        {
            Settings.Default.Cleaning_IncludeLESS = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesLESS_EnablesForProjectItem()
        {
            Settings.Default.Cleaning_IncludeLESS = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesLESS_DisablesForDocumentWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeLESS = false;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesLESS_DisablesForProjectItemWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeLESS = false;
