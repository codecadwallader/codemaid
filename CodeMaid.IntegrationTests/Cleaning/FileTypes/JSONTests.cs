...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\FileTypes\Data\JSON.json", "Data")]
    public class JSONTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _projectItem = TestEnvironment.LoadFileIntoProject(@"Data\JSON.json");
        }
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesJSON_EnablesForDocument()
        {
            Settings.Default.Cleaning_IncludeJSON = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesJSON_EnablesForProjectItem()
        {
            Settings.Default.Cleaning_IncludeJSON = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesJSON_DisablesForDocumentWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeJSON = false;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesJSON_DisablesForProjectItemWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludeJSON = false;
