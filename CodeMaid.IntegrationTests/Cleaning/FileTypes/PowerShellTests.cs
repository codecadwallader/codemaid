...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\FileTypes\Data\PowerShell.ps1", "Data")]
    public class PowerShellTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _projectItem = TestEnvironment.LoadFileIntoProject(@"Data\PowerShell.ps1");
        }
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesPowerShell_EnablesForDocument()
        {
            Settings.Default.Cleaning_IncludePowerShell = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesPowerShell_EnablesForProjectItem()
        {
            Settings.Default.Cleaning_IncludePowerShell = true;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesPowerShell_DisablesForDocumentWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludePowerShell = false;
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningFileTypesPowerShell_DisablesForProjectItemWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_IncludePowerShell = false;
