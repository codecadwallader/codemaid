...
{
    [TestClass]
    [DeploymentItem(@"Cleaning\Update\Data\FileHeaderJSON.json", "Data")]
    [DeploymentItem(@"Cleaning\Update\Data\FileHeaderJSON_Cleaned.json", "Data")]
    public class FileHeaderJSONTests
    {
        #region Setup
        ...
        public void TestInitialize()
        {
            ...
            _projectItem = TestEnvironment.LoadFileIntoProject(@"Data\FileHeaderJSON.json");
        }
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningUpdateFileHeaderJSON_DoesNothingOnSecondPass()
        {
            Settings.Default.Cleaning_UpdateFileHeaderJSON = "{";
        ...
        [TestMethod]
        [HostType("VS IDE")]
        public void CleaningUpdateFileHeaderJSON_DoesNothingWhenSettingIsDisabled()
        {
            Settings.Default.Cleaning_UpdateFileHeaderJSON = null;
