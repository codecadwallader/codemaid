...
{
    public class TypeCustomGrouping
    {
        ...
        static TypeCustomGrouping()
        {
        }

        public TypeCustomGrouping()
        {
        }

        internal TypeCustomGrouping(bool param)
        {
        }

        protected TypeCustomGrouping(int param)
        {
        }

        private TypeCustomGrouping(string param)
        {
        }
        ...
        internal ~TypeCustomGrouping()
        {
        }

        protected ~TypeCustomGrouping()
        {
        }

        private ~TypeCustomGrouping()
        {
        }
