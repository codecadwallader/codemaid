...
namespace SteveCadwallader.CodeMaid.IntegrationTests.Helpers
{
    ...
    public static class TestUtils
    {
        ...
        #endregion Methods: Handling embedded resources
        ...
        #endregion Methods: Handling temporary files and directories
        ...
        #endregion Methods: Handling solutions
        ...
        public static void CreateProjectFromTemplate(string projectName, string templateName, string language)
        {
            ...
            dte.Solution.AddFromTemplate(projectTemplate, projectDirectory, projectName);
        }

        #endregion Methods: Handling projects
        ...
        #endregion Methods: Handling project items
        ...
        #endregion Methods: Handling Toolwindows
